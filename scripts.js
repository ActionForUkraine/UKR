document.addEventListener("DOMContentLoaded", function () {
  ...
  function updatePreview() {
    ...
    const emailPreview = `
      ...
      <p>I am writing to you as a concerned constituent to urge you to support Ukraine's right to defend itself fully and effectively against Russian aggression. While the UK's steadfast support of Ukraine has been admirable, it is essential that we allow Ukraine the necessary tools and freedom to safeguard its own sovereignty.</p>

      <p>By restricting Ukraine from striking key military targets within Russia, we are inadvertently protecting Russian air bases and military infrastructure. These bases are used to launch attacks that continue to devastate Ukrainian civilians and critical infrastructure. Without the ability to neutralize these threats at their source, Ukraine remains at a severe disadvantage, prolonging the war and enabling Russia to maintain its aggressive posture.</p>

      <p>Allowing Ukraine to target military assets within Russia is not about escalating the conflict, but about leveling the playing field. It is a strategic necessity that would undermine Russia’s capacity to wage war. At present, the limitation only serves to shield Russian air bases, giving Russia the advantage at the expense of Ukrainian lives.</p>

      <p>The Ukrainian people are not asking for a blank cheque; they are asking for the right to defend their homes and their freedom. The best way to support them is by empowering their forces to take necessary actions to neutralize military threats, no matter where those threats originate.</p>

      <p>I respectfully urge you to reconsider current policies and advocate for Ukraine’s right to strike back where it matters most: inside Russian territory, where many of the attacks on Ukraine are being coordinated and launched.</p>

      <p>Thank you for your time and consideration.</p>

      <p>Yours sincerely,<br>${userName}<br>${constituency}</p>
    `;
...
document.getElementById("emailForm").addEventListener("submit", function (e) {
  ...
  const mpName = selectedMP.name;
  const constituency = selectedMP.constituency;
  const userName = userNameInput.value || "[Your Name]";
...
I am writing to you as a concerned constituent to urge you to support Ukraine's right to defend itself fully and effectively against Russian aggression. While the UK's steadfast support for Ukraine has been admirable, it is essential that we provide Ukraine with the necessary tools and freedom to safeguard its own sovereignty.

By restricting Ukraine from striking key military targets within Russia, we are inadvertently protecting Russian air bases and military infrastructure. These bases are being used to launch attacks that continue to devastate Ukrainian civilians and critical infrastructure. Without the ability to neutralise these threats at their source, Ukraine remains at a severe disadvantage, prolonging the war and enabling Russia to maintain its aggressive posture.

Allowing Ukraine to target military assets within Russia is not about escalating the conflict but about levelling the playing field. It is a strategic necessity that would undermine Russia’s capacity to wage war. At present, this limitation only serves to shield Russian air bases, giving Russia the advantage at the expense of Ukrainian lives.

The Ukrainian people are not asking for a blank cheque; they are asking for the right to defend their homes and their freedom. The best way to support them is by empowering their forces to take necessary actions to neutralise military threats, no matter where those threats originate.

I respectfully urge you to reconsider current policies and advocate for Ukraine’s right to strike back where it matters most: inside Russian territory, where many of the attacks on Ukraine are being coordinated and launched.
